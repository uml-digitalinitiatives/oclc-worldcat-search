...
import {
  AppRecordsContext, AppRecordsDispatchContext, appRecordsReducer, initialRecordsContextState,
} from './context/RecordsContext';
import {
  AppSettingsContext, AppSettingsDispatchContext, appSettingsReducer, initialSettingsContextState,
} from './context/SettingsContext';

export default function App() {
  const [searchSettings, settingsDispatch] = useReducer(
    appSettingsReducer,
    initialSettingsContextState,
  );
  const [records, recordDispatch] = useReducer(
    appRecordsReducer,
    initialRecordsContextState,
  );
  return (
    <StrictMode>
